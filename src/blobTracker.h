...
class BlobTracker
{
	...
	private:
		...
		void callback(const sensor_msgs::ImageConstPtr& immsg, const faceTracking::ROIArrayConstPtr& msg);
		GMM *gmm_model;
		bool im_received;
		typedef message_filters::sync_policies::ApproximateTime<sensor_msgs::Image, faceTracking::ROIArray> MySyncPolicy;
